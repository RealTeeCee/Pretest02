...
a persistence unit "Pretest02ThayPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Pretest02Thay/pom.xml":
...
artifacts ("Pretest02Thay-ejb.jar" and "Pretest02Thay-web.war") are already built. You can build
